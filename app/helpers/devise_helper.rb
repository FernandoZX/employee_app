...
# devise helper
module DeviseHelper
  def devise_error_messages! # rubocop:disable Metrics/AbcSize
    return if resource.errors.empty?

    messages = resource.errors.full_messages.map { |msg| content_tag(:p, "- #{msg}.") }.join
    sentence = I18n.t(
      'errors.messages.not_saved', count: resource.errors.count,
  ...
  def devise_simple_error_messages! # rubocop:disable Metrics/AbcSize,Metrics/MethodLength
    return if resource.errors.empty?
